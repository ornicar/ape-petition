<?php
	$openinviter_settings=array(
		"username"=>"ornicar",
		"private_key"=>"0c0beb4ef0319d79637f7fe46d2f72d8",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to http://diem-project.org/", // http://diem-project.org/ is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to http://diem-project.org/", // http://diem-project.org/ is the website on your account. If wrong, please update your account at OpenInviter.com
		...
		"update_files"=>true,
		"stats_user"=>"a", //Required to access the stats
		"stats_password"=>"a" //Required to access the stats
	);
	?>