...
/**
 * CollecteVersion form base class.
 *
 * @method CollecteVersion getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseCollecteVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('collecte_version[%s]');
