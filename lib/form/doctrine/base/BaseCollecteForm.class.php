...
/**
 * Collecte form base class.
 *
 * @method Collecte getObject() Returns the current form's model object
 *
 ...
 * @version    SVN: $Id$
 */
abstract class BaseCollecteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Collecte', 'column' => array('hash_code')))
    );

    $this->widgetSchema->setNameFormat('collecte[%s]');
