...
/**
 * ActionVersion filter form base class.
 *
 ...
 */
abstract class BaseActionVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('action_version_filters[%s]');
