...
/**
 * ProduitVersion filter form base class.
 *
 ...
 */
abstract class BaseProduitVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('produit_version_filters[%s]');
