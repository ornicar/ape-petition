...
/**
 * PartenaireVersion filter form base class.
 *
 ...
 */
abstract class BasePartenaireVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('partenaire_version_filters[%s]');
