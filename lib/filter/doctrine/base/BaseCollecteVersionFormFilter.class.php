...
/**
 * CollecteVersion filter form base class.
 *
 ...
 */
abstract class BaseCollecteVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('collecte_version_filters[%s]');
