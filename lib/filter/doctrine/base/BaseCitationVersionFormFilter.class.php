...
/**
 * CitationVersion filter form base class.
 *
 ...
 */
abstract class BaseCitationVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('citation_version_filters[%s]');
